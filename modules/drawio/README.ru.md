...
Вставьте полученный SVG в поле виджета **Diagram SVG**.
...
## Демо-дашборды (учебный проект)

| Дашборд | Что показывает |
|---------|----------------|
| Reactor mnemonic | нарисованный вручную SVG, скриптинг по ячейкам |
| Real IntPage | реальный экспортный `.drawio`, адресация по авто-id |
| LLD clone | одна ячейка-шаблон → тайлится под каждый обнаруженный айтем |
| Chunk test | SVG 115 КБ, хранимый/отрисованный через чанки |
