...
Демо-дашборды: **537** reactor (анимированные трубы), **538** реальный `.drawio`,
**539** LLD-клон, **540** chunk-тест (115 КБ), **541** сетевая карта (синтетик-демо):
<http://localhost:8081/zabbix.php?action=dashboard.view&dashboardid=541>
